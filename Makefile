...
# demo.openshift.com/freshrss-operator-bundle:$VERSION and demo.openshift.com/freshrss-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= demo.openshift.com/freshrss-operator
...
IMG ?= quay.io/saas-patterns/freshrss-operator:$(VERSION)
